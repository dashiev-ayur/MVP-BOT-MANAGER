...
| UI | Админка `web/` ([frontend.md](./frontend.md), [FRONTEND_PLAN.md](./FRONTEND_PLAN.md)) | ✅ принята |
...
**Статус фазы:** ✅ принята (2026-07-19)  
...
- [x] Список нод
- [x] Список ботов + фильтры + refresh
- [x] Экран обзора (сводки + «требуют внимания»)
- [x] **Принято вами** (2026-07-19)
...
- [x] Toasts + авто-poll; обновить README — UI-6.3
- [x] **Принято вами (UI-6.3)** (2026-07-19)
- [x] **Принято вами** (весь UI-6) (2026-07-19)

### Закрытие Phase UI

- [x] Критерии приёмки [frontend.md](./frontend.md) §13.1 + сценарий §13.2 — пройдены поблочно UI-0a…UI-6
- [x] Все нужные блоки с «Принято вами» (см. [FRONTEND_PLAN.md](./FRONTEND_PLAN.md))
- [x] **Принято вами** (фаза целиком) (2026-07-19)
